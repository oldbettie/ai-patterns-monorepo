  ...
  const steps = [
    {
      ...
      desc: ["Drop your PDF into the editor.", "It opens instantly in your browser.", "Nothing is sent to any server."]
    },
    {
      icon: PenTool,
      title: "Step 2: Edit & Sign",
      desc: ["Add text anywhere on the page.", "Draw or upload your signature.", "Drag, resize, and position everything exactly where you need it."]
    },
    {
      icon: Download,
      title: "Step 3: Download",
      desc: ["Click download and your edited PDF", "saves directly to your device.", "That's it. No paywall. No watermark. No signup prompt."]
    }
  ]
