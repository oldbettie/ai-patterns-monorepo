...
// @summary: QRCode Monkey alternative comparison page targeting "qrcode monkey alternative" keywords
...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'Free QRCode Monkey Alternative — No Watermarks, No Download Limits',
    description: 'QRCode Monkey adds watermarks. Simplified QR is genuinely free — unlimited PNG and SVG, no watermarks.',
  },
}

export default function QrcodeMonkeyAlternativePage() {
  const t = useTranslations('pages.alternatives.qrcodeMonkey')
  ...
  const comparisonRows = [
    ...
    { feature: t('row5Feature'), us: t('row5Us'), them: t('row5Them'), positiveUs: true, positiveForThem: true },
    { feature: t('row6Feature'), us: t('row6Us'), them: t('row6Them'), positiveUs: true, positiveForThem: true },
    { feature: t('row7Feature'), us: t('row7Us'), them: t('row7Them'), positiveUs: true, positiveForThem: true },
    { feature: t('row8Feature'), us: t('row8Us'), them: t('row8Them'), positiveUs: true, positiveForThem: false },
    { feature: t('row9Feature'), us: t('row9Us'), them: t('row9Them'), positiveUs: false, positiveForThem: false },
    { feature: t('row10Feature'), us: t('row10Us'), them: t('row10Them'), positiveUs: true, positiveForThem: true },
  ]

  const weWin = [
    { icon: ShieldCheck, title: t('win1Title'), desc: t('win1Desc') },
    { icon: Zap, title: t('win2Title'), desc: t('win2Desc') },
    { icon: WifiOff, title: t('win3Title'), desc: t('win3Desc') },
    { icon: CreditCard, title: t('win4Title'), desc: t('win4Desc') },
  ]
