    ...
    <section className="pt-12 pb-16 md:pt-20 md:pb-32 px-6">
      <div className="container mx-auto max-w-4xl text-center">
        <h1 className="font-display text-5xl md:text-7xl text-foreground leading-[1.1] mb-6">
          The QR Code Generator <br className="hidden md:block" />
          <span className="text-primary">That's Actually Free</span>
        </h1>

        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
          Generate QR codes for URLs, WiFi networks, vCards, SMS, email, and plain text right in your browser.
          No signup. No subscription. No files sent to our servers. Just generate and download.
        </p>
        ...
        <div className="flex flex-col items-center gap-4 mb-12">
          ...
          >
            Generate a QR Code Now — No Account Needed
          </Link>
          <span className="text-sm text-muted-foreground">Works on any device. Download as PNG or SVG.</span>
        </div>
