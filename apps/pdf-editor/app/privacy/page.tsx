        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-12">
          ...
          <section className="p-8 rounded-xl bg-accent/20 border border-primary/20">
            ...
            <p className="text-foreground text-lg leading-relaxed">
              SimplifiedPDF is built on a simple principle: <strong>your files are yours.</strong>
              Nothing you edit in SimplifiedPDF is ever uploaded to our servers, stored on our systems,
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              When you open a PDF in SimplifiedPDF, the file is loaded directly into your browser using
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              SimplifiedPDF collects minimal, non-personal data to keep the service running and understand
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              SimplifiedPDF uses no advertising cookies and no cross-site tracking cookies.
          ...
          <section>
            ...
            <ul className="space-y-3 text-muted-foreground">
              <li className="flex items-start gap-3">
                <span className="text-primary mt-1">•</span>
                <span><strong className="text-foreground">Vercel</strong> — SimplifiedPDF is hosted on Vercel. Vercel receives standard web server logs (IP address, request path, timestamp) for infrastructure purposes. See Vercel&apos;s privacy policy for details.</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-primary mt-1">•</span>
