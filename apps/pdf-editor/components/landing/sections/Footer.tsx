      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-[#F0EFE9]/60 dark:text-muted-foreground text-sm">
              ...
              <li><Link href={AppRoutes.signPdf} className="hover:text-white dark:hover:text-foreground transition-colors">{t('signPdf')}</Link></li>
              <li><Link href={AppRoutes.editPdf} className="hover:text-white dark:hover:text-foreground transition-colors">{t('editPdf')}</Link></li>
              <li><Link href={AppRoutes.editor} className="hover:text-white dark:hover:text-foreground transition-colors">{t('editor')}</Link></li>
              <li><a href={ExternalLinks.qrApp} className="hover:text-white dark:hover:text-foreground transition-colors">{t('simplifiedQR')}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-[#F0EFE9]/60 dark:text-muted-foreground text-sm">
              ...
              <li><a href="mailto:jayleaton@doriracers.com" className="hover:text-white dark:hover:text-foreground transition-colors">{t('contact')}</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/10 dark:border-border flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-[#F0EFE9]/40 dark:text-muted-foreground">
          ...
          <div className="flex gap-6">
            ...
            <a href="/terms-and-conditions.pdf" target="_blank" rel="noopener noreferrer" className="hover:text-white dark:hover:text-foreground transition-colors">{t('terms')}</a>
          </div>
        </div>
      </div>
    </footer>
